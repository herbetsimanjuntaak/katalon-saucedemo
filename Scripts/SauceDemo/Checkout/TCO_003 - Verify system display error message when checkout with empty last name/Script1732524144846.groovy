...
WebUI.setText(findTestObject('SauceDemo/Checkout/lastNameInput'), '')
...
WebUI.verifyElementText(findTestObject('SauceDemo/LoginFormPage/messageErrorLabel'), 'Error: Last Name is required')

...
WebUI.setText(findTestObject('SauceDemo/Checkout/firstNameInput'), '')
...
WebUI.verifyElementText(findTestObject('SauceDemo/LoginFormPage/messageErrorLabel'), 'Error: First Name is required')

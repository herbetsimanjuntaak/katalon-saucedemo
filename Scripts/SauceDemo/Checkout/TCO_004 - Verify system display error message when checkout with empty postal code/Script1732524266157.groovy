...
WebUI.setText(findTestObject('SauceDemo/Checkout/postalCodeInput'), '')

WebUI.click(findTestObject('SauceDemo/Checkout/continueButton'))

WebUI.verifyElementText(findTestObject('SauceDemo/LoginFormPage/messageErrorLabel'), 'Error: Postal Code is required')
